...
Owner = "Dark_Hacker_Inside"
repo = "https://github.com/rezoxmod/Music-Player"
@sree.on(events.NewMessage(pattern="^/start"))
async def start(event):
    buttns = [Button.url("••ѕυρροяτ••", "https://t.me/Dark_Hacker_Inside"), Button.url("••ʀєρο••", f'{repo}')]
...
async def start(event):
    ...
    if event.sender.id not in OP:
        await event.reply(
            "Hello!\nI Can Play Your Song. 🎧\n\nMake your own bot from this [Repository⚡](https://github.com/rezoxmod/Music-Player)",
            link_preview=False,
        )       
...
print("Join @Dark_Hacker_Inside if you facing any kind of issue!!")
